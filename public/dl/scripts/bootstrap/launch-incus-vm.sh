...
# images:ubuntu/24.04 image does not include cloud-init).
IMAGE="${INCUS_IMAGE:-images:ubuntu/24.04/cloud}"
...
Environment overrides:
  INCUS_IMAGE     image to launch (default: images:ubuntu/24.04/cloud)
